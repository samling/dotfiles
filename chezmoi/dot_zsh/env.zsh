...
#=== ripgrep
# ripgrep has no XDG default; without this var the config file is ignored.
...
FZF_COLORS="--color=bg+:-1,selected-bg:-1,spinner:#f5e0dc,hl:#f38ba8 --color=fg:#cdd6f4,header:#f38ba8,info:#cba6f7,pointer:#f5e0dc --color=marker:#b4befe,fg+:#cdd6f4,prompt:#cba6f7,hl+:#f38ba8 --color=border:#313244,label:#cdd6f4,preview-border:#a6adc8"
...
# Hide the gutter
export FZF_DEFAULT_OPTS="${FZF_DEFAULT_OPTS:+$FZF_DEFAULT_OPTS }--gutter ' '"
