...
const SysTray = (): BarBoxChild => {
    ...
    const ignored = Variable<string[]>([]); // TODO: Add ignored items to options
    const customIcons = Variable<Record<string, { icon: string; color: string }>>({}); // TODO: Add custom icons to options

    const componentChildren = Variable.derive(
        [bind(systemtray, 'items'), bind(ignored), bind(customIcons)],
